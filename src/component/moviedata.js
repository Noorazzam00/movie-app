...
var movies = [
    { 
      ...
      posterURL: require("../img/movieone.jpg"),
      rating: 8.5,
    },
    {
      id:"2",
      ...
      posterURL: require("../img/infinity war.jpg"),
      rating: 8.5,
    },
    {
      id:"3",
      ...
      posterURL: require("../img/The_Experiment.jpg"),
      rating: 6.5,
    },
    {
      id:"4",
      ...
      posterURL: require("../img/images.jpeg"),
      rating: 8,
    },
    {
      id:"5",
      title: `What If...? "TV Series"`,
      ...
      posterURL:  require("../img/whatif.jpeg"),
      rating: 7.5,
    },
    {
      id:"6",
      title: "The Blue Elephant 2",
      description: "A meeting with a new inmate in the psychiatric hospital flips Dr. Yehia's life upside down, he prophesies that the death of his entire family is only three days away.",
      posterURL: require("../img/blue.jpeg"),
      rating: 8.2,
    },
    {
      id:"7",
      title: `Squid Game "TV Series"`,
      ...
      posterURL: require ("../img/Squid Game.jpeg"),
      rating: 8.1,
    },
    {
      id:"8",
      ...
      posterURL: require ("../img/Mindhunter.jpeg"),
      rating: 8.6,
    }
  ];
